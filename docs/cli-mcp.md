...
- **Linux CLI tarball** ships `sxpe` / `sxpe_mcp` plus `sxpe-cli.sh` / `sxpe-mcp.sh`. Both are on [v0.7.3](https://github.com/tofb15/sxpe/releases/tag/v0.7.3). Build: [building.md](building.md).
