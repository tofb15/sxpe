...
Contents, **Welcome…** (same tip as first launch), Common tasks… (opens [workflows](workflows.md)), **Check for update…**, **Feedback…** (opens [GitHub Issues](https://github.com/tofb15/sxpe/issues)), About, Warranty, Licence.
